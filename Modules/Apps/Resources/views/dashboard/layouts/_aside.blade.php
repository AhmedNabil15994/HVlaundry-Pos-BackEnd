    ...
    <div class="page-sidebar navbar-collapse collapse">
        ...
        @if (\Auth::user()->can(['show_slider', 'show_coupon', 'show_notifications', 'show_advertising']))
            <ul class="page-sidebar-menu  page-header-fixed" data-keep-expanded="false" data-auto-scroll="true"
                data-slide-speed="200">
                <li
                    class="nav-item  {{ active_slide_menu(['slider', 'coupons', 'notifications', 'advertising-groups', 'advertising','rechargeCoupons']) }}">
                    <a href="javascript:;" class="nav-link nav-toggle">
...
{{--                            </li>--}}
                        ...
                        @permission('show_coupon')
                            ...
                            <li class="nav-item {{ active_menu('rechargeCoupons') }}">
                                <a href="{{ url(route('dashboard.recharge_coupons.index')) }}" class="nav-link nav-toggle">
                                    {{-- <i class="icon-calculator"></i> --}}
                                    <span class="title">{{ __('apps::dashboard.aside.recharge_coupons') }}</span>
                                </a>
                            </li>
                        @endpermission
