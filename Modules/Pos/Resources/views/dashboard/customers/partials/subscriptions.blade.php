<div class="card mt-5 w-100 subscriptions">
    ...
    <script>
        ...
        var subscriptionsData = function () {
                    ...
                    columnDefs: [
                        ...
                        },
                        {
                            ...
                            render: function (data, type, row) {
                                let url = "{{route('dashboard.pos.subscriptions.show',['id'=>':id'])}}".replace(":id",data);
                                return `
            ...
            var handleSubscriptionsDeleteRows = () => {
                ...
                const dataContainer = document.querySelector('.subscriptions');
                        ...
                        Swal.fire({
                            ...
                            if (result.value) {
                                ...
                                Swal.fire({
                                    ...
                                    $.ajax({
                                        type: "DELETE",
                                        url:"{{route('dashboard.baqat_subscriptions.destroy',['id'=>':id'])}}".replace(':id',item_id),
                    ...
                    Swal.fire({
                        ...
                        if (result.value) {
                            ...
                            Swal.fire({
                                ...
                                $.ajax({
                                    type: "GET",
                                    url:"{{route('dashboard.baqat_subscriptions.deletes')}}",
                                    data:{
            ...
            return {
                init: function () {
                    ...
                    // handleSubscriptionsSearchDatatable();
                    initSubscriptionsToggleToolbar();
                    handleSubscriptionsDeleteRows();
                }
            }
