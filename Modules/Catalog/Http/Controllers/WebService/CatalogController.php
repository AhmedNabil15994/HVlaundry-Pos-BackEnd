...
use Modules\Catalog\Transformers\WebService\StarchTypeResource;
...
class CatalogController extends WebServiceController
{
    ...
    public function getFilterData(Request $request)
    {
        ...
        $result = FilteredOptionsResource::collection($options);

        return $this->response($result);
    }

    public function getStarchTypes(Request $request){
        return $this->response(StarchTypeResource::collection(StarchType::active()->orderBy('sort','asc')->get()));
    }
}
