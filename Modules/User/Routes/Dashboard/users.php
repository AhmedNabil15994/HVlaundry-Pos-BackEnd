...
Route::group(['prefix' => 'users'], function () {
    ...
    Route::get('{id}/getOne','Dashboard\UserController@getOne')
        ->name('dashboard.users.getOne')
        ->middleware(['permission:show_users']);
    ...
    Route::get('user/addresses', 'Dashboard\UserController@getUserAddressesList')->name('dashboard.users.get_user_addresses');
});
