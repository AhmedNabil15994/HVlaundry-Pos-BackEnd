...
use Modules\Coupon\Http\Requests\Dashboard\RechargeCouponRequest;
use Modules\Coupon\Repositories\Dashboard\CouponRepository;
use Modules\Coupon\Repositories\Dashboard\RechargeCouponRepository;
use Modules\Coupon\Transformers\Dashboard\CouponResource;
use Modules\Coupon\Transformers\Dashboard\RechargeCouponResource;
use Modules\Slider\Transformers\Dashboard\SliderResource;


class RechargeCouponController extends Controller
{
    protected $coupon;

    function __construct(RechargeCouponRepository $coupon)
    {
        $this->coupon = $coupon;
    }
    ...
    {
        return view('coupon::dashboard.recharge.index');
    }
    ...
    public function datatable(Request $request)
    {
        ...
        $datatable['data'] = RechargeCouponResource::collection($datatable['data']);
    ...
    {
        return view('coupon::dashboard.recharge.create');
    }

    public function store(RechargeCouponRequest $request)
    {
        try {
    ...
    {
        return view('coupon::dashboard.recharge.show');
    }

    public function edit($id)
    {
        $coupon = $this->coupon->findById($id);
        return view('coupon::dashboard.recharge.edit', compact('coupon'));
    }

    public function update(RechargeCouponRequest $request, $id)
    {
        try {
