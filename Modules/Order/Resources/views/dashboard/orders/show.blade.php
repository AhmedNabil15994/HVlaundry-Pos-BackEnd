                    ...
                    <div class="thermal-invoice">
                        ...
                        <div class="row secondRow border-bottom">
                            ...
                            <div class="row tableRow">
                                <div class="col-xs-12">
                                    ...
                                    <div class="col-xs-9">{{isset($order->orderAddress) ? $order->orderAddress->username : $order->user->name}}</div>
                                </div>
                            </div>
                            ...
                            <div class="row tableRow">
                                <div class="col-xs-12">
                                    ...
                                    <div class="col-xs-9">+{{(substr((isset($order->orderAddress) ? $order->orderAddress->mobile : $order->user->mobile), 0, 3) == '965' ? '' : '965').(isset($order->orderAddress) ? $order->orderAddress->mobile : $order->user->mobile)}}</div>
                                </div>
                            </div>
                            ...
                            <div class="row tableRow">
                                <div class="col-xs-12">
                                    ...
                                    @endphp
                                    <div class="col-xs-9">
                                        {{$pickup_times ? $order->orderTimes->receiving_data['receiving_date'] : ''}}
                            ...
                            <div class="row tableRow">
                                <div class="col-xs-12">
                                    ...
                                    <div class="col-xs-9">
                                        {{$delievery_times ? $order->orderTimes->delivery_data['delivery_date'] : ''}}
                        ...
                        <div class="itemsTable">
                            ...
                            <div class="row p-20 border-bottom mb-10">
                                ...
                                <div class="col-xs-3"></div>
                                <div class="col-xs-3 ">
                                    <p class="m-5">{{$order->original_subtotal . ' ' .__('KD')}}</p>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="orderSummary">
                            ...
                            <div class="row p-20">
                                ...
                                <div class="col-xs-3">{{($order->orderCoupons ? $order->calcDiscount() : $order->off) . ' ' .__('KD')}}</div>
                            </div>
                            <div class="row p-20">
                                <div class="col-xs-9">
...
{{--                                            </span>--}}
{{--                                        </span>--}}
{{--                                        <span class="order_Status no-print">--}}
{{--                                            <span--}}
{{--                                                style="background-color: #000000;padding: 2px 14px; color: #ffffff; border-radius: 25px; float: none; margin: 0px 10px;">--}}
{{--                                                <b>--}}
{{--                                                    {{ __('order::dashboard.orders.show.order_added_by.label') . ' : ' . __('order::dashboard.orders.show.order_added_by.' . $order->order_added_by) }}</b>--}}
{{--                                            </span>--}}
{{--                                        </span>--}}
{{--                                    </div>--}}
{{--                                </div>--}}
...
{{--                                            <br />--}}
{{--                                            <span class="bold">--}}
{{--                                                {{ __('order::dashboard.orders.show.order_type') }} :--}}
{{--                                            </span>--}}
{{--                                            {{ $order->order_type == 'direct_with_pieces' ? __('Orders with pieces') : __('Orders without pieces') }}--}}
{{--                                            <br />--}}
{{--                                            <span class="bold">--}}
{{--                                                {{ __('order::dashboard.orders.show.is_fast_delivery') }} :--}}
{{--                                            </span>--}}
...
{{--                                                <i class="fa fa-edit show_client_tag no-print"--}}
{{--                                                    style="color:#32c5d2; cursor: pointer;"--}}
{{--                                                    onclick="toggleClientNotes()"></i>--}}
{{--                                                <span class="hide_client_tag no-print">--}}
{{--                                                    <i class="fa fa-close" style="color:#fa5661; cursor: pointer;"--}}
{{--                                                        onclick="toggleClientNotes()"></i>--}}
{{--                                                </span>--}}
{{--                                            </b>--}}
{{--                                            <span id="client_note">{{ $order->notes ?? '---' }}</span>--}}
{{--                                            <div style="padding: 20px 74px;" class="hide_client_tag no-print">--}}

{{--                                                {!! Form::open([--}}
{{--                                                    'url' => route('dashboard.orders.client.note', $order->id),--}}
{{--                                                    'role' => 'form',--}}
{{--                                                    'page' => 'form',--}}
...
{{--                                                    <textarea class="form-control" name="notes" rows="8" cols="6">{{ $order->notes }}</textarea>--}}
{{--                                                </div>--}}
...
{{--                                                    style="color:#32c5d2; cursor: pointer;" onclick="toggleAdminTag()"></i>--}}
...
{{--                                @if (!is_null($order->orderTimes) && !is_null($order->orderTimes->receiving_data))--}}
{{--                                    <div class="row">--}}
{{--                                        <div class="col-md-6 col-xs-12">--}}
{{--                                            <div style="margin: 10px;">--}}
{{--                                                <b>{{ __('order::dashboard.orders.show.order_time_date.receiving_datetime') }}--}}
{{--                                                    : </b>--}}
{{--                                                <span>{{ $order->orderTimes->receiving_data['receiving_date'] . ' - ' . $order->orderTimes->receiving_data['receiving_time'] }}</span>--}}
{{--                                            </div>--}}
{{--                                        </div>--}}
{{--                                    </div>--}}
{{--                                @endif--}}

{{--                                @if (!is_null($order->orderTimes) && !is_null($order->orderTimes->delivery_data))--}}
{{--                                    <div class="row">--}}
{{--                                        <div class="col-md-6 col-xs-12">--}}
{{--                                            <div style="margin: 10px;">--}}
{{--                                                <b>{{ __('order::dashboard.orders.show.order_time_date.delivery_datetime') }}--}}
{{--                                                    : </b>--}}
{{--                                                <span>{{ $order->orderTimes->delivery_data['delivery_date'] . ' - ' . $order->orderTimes->delivery_data['delivery_time'] }}</span>--}}
{{--                                            </div>--}}
{{--                                        </div>--}}
{{--                                    </div>--}}
{{--                                @endif--}}
