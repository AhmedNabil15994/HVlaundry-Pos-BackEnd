...
return [
    ...
    'orders' => [
        ...
        'show' => [
            ...
            'status' => 'Order Status',
            'notes' => 'Notes From Client',
            'order_notes' => 'Order Notes',
            'edit' => 'Edit Order Status',
            'invoice' => 'Invoice',
            'order_is_ready' => 'Order is ready',
            'order_is_processing' => 'Order Processing',
            'order_is_received'   => 'Delivered to the delegate',
            'order_is_delivered'  => 'Delivered to customer',
            'order_is_on_the_way' => 'On the way to customer',
            ...
            'order_history_log' => 'History Log',
            'admin_note' => 'Admin Note',
            'payment_type' => 'Payment Type',
            'confirm_payment' => 'Cash Receipt',
            'confirm_payment_dec' => 'Are you sure to confirm the order cash receipt?',
            'cancel_payment' => 'Cancel Order',
            'cancel_payment_dec' => ' Are you sure to cancel the order?',

            'invoice_customer' => 'Customer Invoice',
            'invoice_details' => 'Order Details',
            'change_order_status' => 'Change Order Status',
            'delivery_time_note' => 'Delivery Note',

            'payment_confirmed_at' => 'Payment confirmed in',
            'order_type' => 'Order Type',
            'order_time_date' => [
                'receiving_datetime' => 'Time of Receipt',
                'delivery_datetime' => 'Delivery Time',
            ],
            'is_fast_delivery' => 'Fast Delivery',
            'yes' => 'Yes',
            'no' => 'No',
        ...
        'create' => [
            ...
            'btn' => [
                'save' => 'Save Order',
                'add_product' => 'Add Products To Order',
                'delete' => 'Delete',
            ],
            'form' => [
                'products' => 'Products',
                ...
                'select_user_addresses' => '--- Select User Address ---',
                ...
                'times' => [
                    'label' => 'Times',
                    'receiving_times' => 'Receiving Times',
        ...
        'starch_status' => 'Starch Status',
        'with_strach'   => 'With Strach',
        'without_strach'   => 'Without Strach',
        'extra_strach'   => 'Extra Strach',
    ],
    'order_drivers' => [
        'validation' => [
            'user_id' => [
