                                                ...
                                                <table class="table table-bordered text-center" style="width: 80%">
                                                    <thead>
                                                        ...
                                                        <th class="text-center" style="width: 120px">
                                                            {{ __('order::dashboard.orders.create.form.table.qty') }}
                                                        </th>
                                                        <th class="text-center">
                                                            ...
                                                            @foreach ($order->orderCustomAddons as $item)
                                                                <tr
                                                                    ...
                                                                    <td class="text-center">
                                                                        {{$item->orderProduct->starchType->title}}
                                                                    </td>
                                                                    <td>
...
@section('scripts')
    ...
    <script>
        ...
        function getDeliveryWorkingTimes() {
            ...
            var state_id = "{{!is_null($order) && isset($order->orderAddress) ? $order->orderAddress->state_id : 0}}";
            if(parseInt(state_id) === 0){
                state_id = $('select[name="address_id"] option:selected').attr('data-state')
            }
            $.ajax({
                method: "GET",
